...
public class RecipeEditDialog extends Dialog {
    ...
    public RecipeEditDialog(Context context) {
    ...
    private void setLayout(){
        ...
        modifyBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dismiss();
                Intent intent = new Intent(MyApplication.RecipeContext(), WriteRecipeMainActivity.class);
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                CancelDeleteRecipe cancelDeleteRecipe = new CancelDeleteRecipe(getContext());
                cancelDeleteRecipe.show();
                dismiss();
            }
        });
    }
