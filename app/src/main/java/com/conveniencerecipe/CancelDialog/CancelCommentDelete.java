 ...
 */
public class CancelCommentDelete extends Dialog {
    @Override
    ...
    public CancelCommentDelete(Context context, String commentId) {
    ...
    private void setLayout(){
        ...
        cancelImage.setImageResource(R.drawable.delete_comment1);
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Request request = new Request.Builder()
                                    .url(String.format(NetworkDefineConstant.SERVER_URL_QNA_COMMENT, commentId))
                            ...
                            if(response != null) {
                                response.close();
                                QnaDetailActivity.qnaCommentDialog.dismiss();
                            }
                        }
                    }
                }).start();
