 ...
 */
public class CancelDeleteQna extends Dialog {
    @Override
    ...
    public CancelDeleteQna(Context context) {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Request request = new Request.Builder()
                                    .url(String.format(NetworkDefineConstant.SERVER_URL_QNADETAIL, QnaDetailActivity.postingId))
